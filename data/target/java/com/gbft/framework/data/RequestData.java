...
private static final long serialVersionUID = 0L;
  ...
  public static final int EXE_VALUE_FIELD_NUMBER = 11;
  private int exeValue_ = 0;
  /**
   * <code>int32 exe_value = 11;</code>
   * @return The exeValue.
   */
  @java.lang.Override
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (exeValue_ != 0) {
      output.writeInt32(11, exeValue_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getExeValue()
        != other.getExeValue()) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + EXE_VALUE_FIELD_NUMBER;
    hash = (53 * hash) + getExeValue();
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.gbft.framework.data.RequestData other) {
      ...
      if (other.getExeValue() != 0) {
        setExeValue(other.getExeValue());
      }
    ...
    /**
     * <code>int32 exe_value = 11;</code>
     * @param value The exeValue to set.
     * @return This builder for chaining.
     */
    public Builder setExeValue(int value) {
