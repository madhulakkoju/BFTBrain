...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      FaultData.class.getName());
  }
  // Use FaultData.newBuilder() to construct.
  private FaultData(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private FaultData() {
  ...
  public static final class Builder extends
    ...
    private void ensureBlockedTargetsIsMutable() {
      if (!blockedTargets_.isModifiable()) {
        blockedTargets_ = makeMutableCopy(blockedTargets_);
      }
      bitField0_ |= 0x00000001;
    }
    /**
    ...
    private void ensureDelayedTargetsIsMutable() {
      if (!delayedTargets_.isModifiable()) {
        delayedTargets_ = makeMutableCopy(delayedTargets_);
      }
      bitField0_ |= 0x00000002;
    }
    /**
